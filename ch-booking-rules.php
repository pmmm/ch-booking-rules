 ...
 * Description: Épocas, mínimos e promoções (recorrentes) + código promocional para Fluent Forms. v1.3.7: melhorias no cálculo do total (value/label), parser de datas e UX.
 * Version: 1.3.8
